...
export const note_settlement_procedure_Rial_withdrawals = [
  {
    name: 'برداشت ریالی در بیت‌آسیا ، به مقصد همه بانک ها بر اساس سیکل پایا خواهد بود.'
  },
  {
    name: 'کارمزد برداشت ریالی مربوط به سیستم بانکی بوده و توسط سیستم پرداخت یار گرفته می شود و سایت بیت‌آسیا در آن ذینفع نیست.'
  },
  {
  ...
  {
    name: 'واریز ریالی به بیت‌آسیا بدون کارمزد برای کاربران عزیز انجام می گردد.'
  },
