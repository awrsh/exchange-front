...
const BuyTether = ({ select }: { select: number }) => {
    ...
    // total tomaan
    const total = user?.wallets.find((crypto) => crypto.currency_id.code === "USDT")
    ...
    console.log(total?.balance,"jffjfj")
    return (
        <div className='mt-3'>
            ...
            <form onSubmit={formik.handleSubmit} className='mt-5'>
                ...
                <Input
                    ...
                    label='موجودی تتر'
                    formik={formik}
                    value={total?.balance ? Number(total?.balance) : ""}
                    subLabel='تتر'
                />
                <Input
                    className='mt-3'
