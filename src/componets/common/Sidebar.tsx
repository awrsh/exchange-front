        ...
        <div className="!min-w-[260px]">
          ...
          <div className=" flex flex-col mt-5 gap-2 px-2">
            {header_menu.map((menu, idx) => (
              <Link
                className={`flex items-center justify-center w-full px-2  py-[0.7rem] gap-2 rounded-xl hover:bg-neutral-300 ${location.pathname === menu.url ? "bg-int text-white " : "text-neutral-500 "}`} to={menu.url} key={idx}>
